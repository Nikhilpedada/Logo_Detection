...
output_dir = '/content/gdrive/MyDrive/'
os.makedirs(output_dir, exist_ok=True)

# Update paths
video_path = '/content/gdrive/MyDrive/contentMake_Amazing_Cups_Using_Soda_Cans_and_earn_money.mp4'
model_path = '/content/gdrive/MyDrive/Dataset/best.pt'
